  ...
  technology: [
    {
      name: 'NLU',
      product_link:
        'https://ondewo.com/en/products/natural-language-understanding/',
      clients: {
      ...
      versions: [
        { number: '4.9.0', link: 'ondewo-nlu-api/4.9.0/' },
        { number: '4.8.0', link: 'ondewo-nlu-api/4.8.0/' },
        { number: '4.7.0', link: 'ondewo-nlu-api/4.7.0/' },
        { number: '4.6.0', link: 'ondewo-nlu-api/4.6.0/' },
        { number: '4.5.0', link: 'ondewo-nlu-api/4.5.0/' },
        { number: '4.4.0', link: 'ondewo-nlu-api/4.4.0/' },
        { number: '4.3.0', link: 'ondewo-nlu-api/4.3.0/' },
        { number: '4.2.0', link: 'ondewo-nlu-api/4.2.0/' },
        { number: '4.1.0', link: 'ondewo-nlu-api/4.1.0/' },
        { number: '4.0.0', link: 'ondewo-nlu-api/4.0.0/' },
        { number: '3.5.2', link: 'ondewo-nlu-api/3.5.2/' },
        { number: '3.5.1', link: 'ondewo-nlu-api/3.5.1/' },
        { number: '3.5.0', link: 'ondewo-nlu-api/3.5.0/' },
        { number: '3.4.0', link: 'ondewo-nlu-api/3.4.0/' },
    ...
    {
      name: 'S2T',
      product_link: 'https://ondewo.com/en/products/speech-to-text/',
      clients: {
      ...
      versions: [
        { number: '5.6.0', link: 'ondewo-s2t-api/5.6.0/' },
        { number: '5.5.0', link: 'ondewo-s2t-api/5.5.0/' },
        { number: '5.4.0', link: 'ondewo-s2t-api/5.4.0/' },
        { number: '5.3.0', link: 'ondewo-s2t-api/5.3.0/' },
    ...
    {
      name: 'T2S',
      product_link: 'https://ondewo.com/en/products/text-to-speech/',
      clients: {
      ...
      versions: [
        { number: '5.2.0', link: 'ondewo-t2s-api/5.2.0/' },
    ...
    },
    {
      name: 'SIP',
      product_link:
        'https://ondewo.com/en/products/voip-telephone-system-integration/',
      clients: {
    ...
    },
    {
      ...
      versions: [
        { number: '6.7.0', link: 'ondewo-vtsi-api/6.7.0/' },
        { number: '6.6.0', link: 'ondewo-vtsi-api/6.6.0/' },
        { number: '6.5.0', link: 'ondewo-vtsi-api/6.5.0/' },
        { number: '6.4.0', link: 'ondewo-vtsi-api/6.4.0/' },
        { number: '6.3.0', link: 'ondewo-vtsi-api/6.3.0/' },
        { number: '6.2.0', link: 'ondewo-vtsi-api/6.2.0/' },
        { number: '6.0.0', link: 'ondewo-vtsi-api/6.0.0/' },
    ...
    {
      name: 'SURVEY',
      product_link: 'https://ondewo.com/en/products/call-centre-ai/',
      clients: {

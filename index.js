...
function setupPage() {
	for (let tech of ondewo.ondewo.technology) {
		const divTemp = `
            <div class="d-flex border border-primary flex-row justify-content-center rounded flex-nowrap p-2 m-3">
			<div class="d-flex flex-column w-50">
				...
				<p>Clients SDKs on Github for</p>
				<div class="d-flex flex-row flex-nowrap">
					<img
						...
						alt="Python Logo"
					/>
					<img class="tech-logo" onclick="openLink('${tech.clients.angular}')" src="${ondewo.ondewo.logos.angular_logo}" alt="Angular Logo" />
					<img class="tech-logo" onclick="openLink('${tech.clients.nodejs}')" src="${ondewo.ondewo.logos.nodejs_logo}" alt="Nodejs Logo" />
					<img class="tech-logo" onclick="openLink('${tech.clients.typescript}')" src="${ondewo.ondewo.logos.typescript_logo}" alt="Typescript Logo" />
					<img class="tech-logo" onclick="openLink('${tech.clients.js}')" src="${ondewo.ondewo.logos.js_logo}" alt="Javascript Logo" />
				</div>
			</div>
			<div class="d-flex flex-column w-50 ">
